...
<div class="container">
    <div class="card">
        ...
        <div class="">
        <div class="ml-5 mr-5 text-centet">
...
-->
                                <select class="form-select" name="año" id="year">
                                    <option value="0">Año</option>
...
-->
                        ...
                        <div class="col-4">
                            <div class="form-group form-check">
                                ...
                                <input type="number" class="form-control" name="edicion" id="edicion" placeholder="edicion">
                            </div>
                        </div>
                    </div>
                    <div class="row">
