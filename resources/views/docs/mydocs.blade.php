...
@section('content')
    ...
    <div class="container-docs">
        ...
        @if($docs)
            ...
            <div class="col-md-8  img-div  offset-md-2 bg-document rounded-3 p-3 mt-4 ">
                <h5 class="">Copia de Cedula</h5>
                <img src="{{route('getDoc',['filename'=> $docs->copia_cedula])}}" alt="" srcset="">
            </div>

            <div class="col-md-8 img-div  bg-document offset-md-2 bg-white rounded-3 p-3 mt-4 ">
