    ...
    <div class="max-w-6xl mx-auto    sm:px-6 lg:px-8">
        <div class="menu-unefa flex">
            <div class="item-menu flex mt-3 ">
                ...
                <div class="title">
                <h4>Estudiantes</h4>
                <center><a class="btn btn-primary" href="{{route('students_list')}}" role="button">Ver</a></center>
                </div>
            </div>
            <div class="item-menu flex mt-3 ">
                <div class="img-item">
                ...
                <div class="title">
                <h4>Carreras</h4>
                <center><a class="btn btn-primary" href="{{route('category_users')}}" role="button">Ver</a></center>
                </div>
            </div>
        </div>
    </div>
