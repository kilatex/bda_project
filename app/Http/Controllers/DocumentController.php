        ...
        $message = session('message');
         ...
         if( $docs == null){
                ...
                $validate = $this->validate($request,[
                    'planilla_datos_personales' => 'required|image|max:5000',
                    'copia_cedula' => 'required|image|max:5000',
                    'record_academico' => 'required|image|max:5000',
                    'constancia_culminacion_servicio_comunitario' => 'required|image|max:5000',
                    'acta_evaluacion_pasantias' => 'required|image|max:5000', 
                    'certificado_pasantias' => 'required|image|max:5000', 
                    'acta_defensa_trabajo_especial_grado' => 'required|image|max:5000', 
                    'constancia_practicas_educativas' => 'required|image|max:5000', 
                    'acta_pasantia_hospitalaria_comunitaria' => 'required|image|max:5000', 
                    'certificado_pastantia_hospitalaria_comunitaria' => 'required|image|max:5000', 
                    'comunicacion_adicional_casos_concretos' => 'required|image|max:5000', 
                    'reconocimientos_amonestaciones' => 'required|image|max:5000', 
                    'titulo_bachiller_fondonegro' => 'required|image|max:5000', 
                    'copia_titulo_bachiller' => 'required|image|max:5000', 
                    'copia_notas_certificadas_educacion_media' => 'required|image|max:5000', 
                    'fotocopia_partida_nacimiento' => 'required|image|max:5000', 
                    'planilla_rusni' => 'required|image|max:5000', 
                    'planilla_din' => 'required|image|max:5000', 
